...
I migrated my own project within 2 hours and I had to move a lot of the customization to the bundle (e.g. the webpack-encore build). See [this PR](https://github.com/kevinpapst/kimai2/pull/202/files) for a live example. 
...
- updated composer.json to reflect bundle dependencies
...
- WIP: a [Demo application](https://github.com/kevinpapst/AdminLTEBundle-Demo) as living documentation for first time users and easier testing
